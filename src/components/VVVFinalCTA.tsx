      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
            Sua <span className="text-brand-orange">Transformação</span> Começa Agora
          </h2>
          
          <Card className="shadow-brand border-2 border-brand-orange/30 bg-white/95 backdrop-blur-sm mb-8">
            <CardContent className="p-8">
              ...
              <div className="bg-brand-orange/10 rounded-lg p-6 mb-8">
