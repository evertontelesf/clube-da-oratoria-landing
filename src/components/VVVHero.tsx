...
export const VVVHero = () => {
  ...
  return <section className="py-32 bg-gradient-hero text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <img src={logo} alt="Clube da Oratória" className="h-16 w-16 mx-auto mb-6" />
          ...
          <div className="relative bg-black/50 rounded-xl p-8 mb-8 border-2 border-accent/30">
            ...
            <Button variant="cta" size="xl" className="w-full md:w-auto" onClick={() => setIsDialogOpen(true)}>Quero me comunicar com excelência</Button>
          </div>
        </div>
      </div>
