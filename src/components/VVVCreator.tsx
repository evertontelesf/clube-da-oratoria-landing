  ...
  return <section className="py-16 md:py-32 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 md:mb-12 text-foreground px-2">Quem está por trás do Clube da Oratória</h2>
          
          <Card className="shadow-card-brand border-2 border-primary/20">
            <CardContent className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8">
                <div className="flex-shrink-0 w-full md:w-1/3">
                  <img src="/lovable-uploads/674be516-37e4-4ca1-bee1-6a80546e3ed0.png" alt="Everton Teles" className="w-full h-auto rounded-lg object-cover border-4 border-primary max-w-sm mx-auto md:max-w-none md:mx-0" />
                </div>
                <div className="w-full md:w-2/3">
                  <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-center md:text-left">Everton Teles</h3>
